define(['/js/plugin/monitor/monitorInfo.js',
	...
	return {
		...
		base_info : function (paramObj){
			um_ajax_get({
		        url : "monitorview/network/sangforsas/querySangforsasBaseInfoTotal",
		        paramObj : paramObj,
		        isLoad : false,
		...
		cpu_use_chart : function (el ,paramObj,type){
			um_ajax_get({
		        url : "monitorview/network/sangforsas/querySangforsasCpuMemInfo",
		        paramObj : paramObj,
		        isLoad:false,
		        successCallBack : function (data){
		...
		route_info_list : function (el ,paramObj){
			var route_info_list_url="monitorview/network/sangforsas/querySangforsasRouteInfo";
