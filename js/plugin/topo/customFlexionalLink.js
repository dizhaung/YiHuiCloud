define(['jtopo','Json2xml'],function (jtopo,Json2xml){
	...
	customLink.prototype = new JTopo.SquarelyFlexionalLink();
	...
	customLink.prototype.deserialize = function (jsonObj,scene){
		...
		this.lineWidth = jsonObj.extend&&jsonObj.extend.lineWidth?Number(jsonObj.extend.lineWidth):3;
		this.bundleOffset = 50;
		this.bundleGap = 20;
		this.textOffsetY = 3;
		this.strokeColor = jsonObj.extend&&jsonObj.extend.strokeColor?jsonObj.extend.strokeColor:'0,200,255';
		jsonObj._color && (this.strokeColor = jsonObj._color);
		this.alpha = jsonObj.extend&&jsonObj.extend.alpha?Number(jsonObj.extend.alpha):1;
		this.desc = jsonObj._desc;

		this.direction = jsonObj._direction;
		this.offsetGap = jsonObj._offsetGap;
